...
static void sf_gateway_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_c_yoff, 3U, c4_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_c_openloopflag, 7U, c4_d_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 9U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_ref, 10U, c4_sf_marshallOut);
  ...
  for (c4_i8 = 0; c4_i8 < 20; c4_i8++) {
    (*c4_c_rseq)[c4_i8] = c4_rseq[c4_i8];
  }

  for (c4_i9 = 0; c4_i9 < 21; c4_i9++) {
    (*c4_c_vseq)[c4_i9] = c4_vseq[c4_i9];
  }
  ...
  *c4_c_v = c4_v;
  ...
  for (c4_i10 = 0; c4_i10 < 20; c4_i10++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_rseq)[c4_i10], 0U);
  }

  for (c4_i11 = 0; c4_i11 < 21; c4_i11++) {
    _SFD_DATA_RANGE_CHECK((*c4_c_vseq)[c4_i11], 1U);
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i12 = 0; c4_i12 < 21; c4_i12++) {
    c4_b_inData[c4_i12] = (*(real_T (*)[21])c4_inData)[c4_i12];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i14 = 0; c4_i14 < 21; c4_i14++) {
    (*(real_T (*)[21])c4_outData)[c4_i14] = c4_y[c4_i14];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i15 = 0; c4_i15 < 20; c4_i15++) {
    c4_b_inData[c4_i15] = (*(real_T (*)[20])c4_inData)[c4_i15];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i17 = 0; c4_i17 < 20; c4_i17++) {
    (*(real_T (*)[20])c4_outData)[c4_i17] = c4_y[c4_i17];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1841960377U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3854898099U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3267441134U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2786566059U);
}
...
mxArray *sf_c4_mpclib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("WD1YzirMtWTBTxlNfjg7CE");
...
static void mdlSetWorkWidths_c4_mpclib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2863350891U));
  ssSetChecksum1(S,(1485369071U));
  ssSetChecksum2(S,(1867984783U));
  ssSetChecksum3(S,(2719817098U));
